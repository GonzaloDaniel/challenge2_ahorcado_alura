var bancoPalabras = ["PARTIDO", "LIBRO", "AMANECER", "PLAYA", "AMBULANCIA", "HELADERA", "COMPUTADORA", "MUSICA", "REMODELACION", "VENTILADOR", "DESTRUCCION"];
...
const mensajeFinal = (mensaje) => {
    ...
    if(mensaje==1){        
        ...
        mensajePerdida.innerHTML = "Perdiste. Suerte para la proxima";
